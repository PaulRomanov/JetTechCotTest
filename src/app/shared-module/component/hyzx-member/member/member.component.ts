...
export class MemberComponent implements OnInit {
  ...
  demoIndex = [
    {
      title: '会员中心', list: [
        { name: '存款', icon: 'iconjinbi', link: 'deposit', index: '0' },
        { name: '取款', icon: 'iconzaixianchongzhi', link: 'withdrawMoney', index: '1' },
        { name: '金额转换', icon: 'iconzhuanhuan', link: 'transFormAtion', index: '2' },
        { name: '出款管理', icon: 'iconyinhangqia', link: 'bankCard/commonBank', index: '3' },
        { name: '安全中心', icon: 'iconanquan', link: 'security/personalInformation', index: '4' },
        // { name: '实时返水', icon: 'iconqian2', link: 'realtimeRebate', index: '16' }
      ]
    },
    {
      title: '历史记录', list: [
        { name: '账户历史', icon: 'iconlishi', link: 'accountHistory', index: '5' },
        { name: '投注合计', icon: 'iconqian2', link: 'bettingTotal', index: '6' },
        { name: '即时稽核', icon: 'iconaccount-audit', link: 'audit', index: '7' },
        { name: '活动申请记录', icon: 'icontubiao-', link: 'activity', index: '8' },
        { name: '投注历史', icon: 'iconic_history', link: 'betting', index: '9' }
      ]
    },
    {
      title: '自助活动', list: [
        { name: '认证体验金', icon: 'iconrenzhengyonghu', link: 'caijin', index: '14' },
        { name: '签到活动', icon: 'iconqiandao', link: 'signin', index: '15' }
      ]
    },
    {
      title: '全民推广', list: [
        { name: '推广赚钱', icon: 'iconMenu_tuiguangzhuanqian', link: 'spreadMoney/spreadMoneyPay', index: '12' },
        { name: '推广教程', icon: 'iconjiaocheng', link: 'SpreadLesson', index: '13' }
      ]
    },
    {
      title: '消息记录', list: [
        { name: '个人消息', icon: 'iconmessage', link: 'personalNews', index: '10' },
        { name: '系统消息', icon: 'iconyoujian', link: 'historicalNews/latest', index: '11' }
      ]
    }
  ];
    ...
    ****/
    ...
    this.$CommonDataService.ssSwitchon().then((res: Result) => {
      if(res.data.switchon===true){
        this.demoIndex[0].list[5] = { name: '实时返水', icon: 'iconqian2', link: 'realtimeRebate', index: '16' }
      }else{
