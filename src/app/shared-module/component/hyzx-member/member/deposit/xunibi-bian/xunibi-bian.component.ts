...
@Component({
  selector: 'app-xunibi-bian',
  templateUrl: './xunibi-bian.component.html',
  styleUrls: ['./xunibi-bian.component.scss']
})
export class XunibiBianComponent implements OnInit, DoCheck {
  ModeSwiper1: any;
  ModeSwiper2: any;
  ModeSwiper3: any;
  ModeSwiper4: any;
