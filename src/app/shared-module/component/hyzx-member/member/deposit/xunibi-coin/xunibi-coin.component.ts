...
@Component({
  selector: 'app-xunibi-coin',
  templateUrl: './xunibi-coin.component.html',
  styleUrls: ['./xunibi-coin.component.scss']
})
export class XunibiCoinComponent implements OnInit, DoCheck {
  ModeSwiper1: any;
  ModeSwiper2: any;
  ModeSwiper3: any;
  ModeSwiper4: any;
